...
//fetch all users
$sql = "SELECT l.learner_id,l.firstname,l.lastname,l.email,
...
<body>
            ...
            <table border="1">
               ...
               if (mysqli_num_rows($result) > 0) {
                  while ($row = mysqli_fetch_assoc($result)) {
                     ...
                     <td>" . $row['email'] . "</td>                    
                     <td>" . $row['interests'] . "</td>
                     <td><button class='delete_btn' data-id='" . $row['learner_id'] . "'>Delete</button></td>
                     </tr>";
                  }
               } else {
   ...
   <!-- ajax code -->
   <script src="http://127.0.0.1:5500/Styles/jquery.js"></script>
   <script>

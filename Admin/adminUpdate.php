...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $sql = "UPDATE courses SET CourseTitle = ?, description = ?, CreditHour= ? WHERE CourseID = ?";
    $stmt = $conn->prepare($sql);
    $stmt->bind_param("ssii", $title, $description, $credithour, $course_id);
    
    if ($stmt->execute()) {
        // echo "TITLEEEEEEE".$credithour;

...
<body>
    <div class="container">
        ...
        <div class="right-container">
            <h2>Sign up</h2>
            <form onsubmit="return validate()" action="http://localhost/bca-Project-II/webpage/signupdb.php" method="post">
                <!-- <label class="signup">Don't have account? <a href="#">Sign up</a></label> -->
                <input type="first name" placeholder="First Name" id="fn" name="fn">
                <input type="last name" placeholder="Last Name" id="ln" name="ln">
                <input type="email" placeholder="Email" id="e" name="e">
                ...
                <center>
                <label class="signup">Already have an account? <a href="login.php">Log In</a></label>
            </center>
            </form>

    ...
    <div class="container">
        ...
        <div class="right-container">
            ...
            <form onsubmit="return validate()" action="logindb.php" method="post" >
                ...
                <input type="email" id="e" name="e" placeholder="Email">
                <input type="password" id="p" name="pass" placeholder="Password">
                <!-- <label class="forgetpsd"><a href="#">Forget Password?</a></label> -->
                <button type="submit" value="submit" class="login-btn">Login</button>
                <label><a href="adminLogin.php"><u>Admin Login ?</u></a></label>
            </form>
